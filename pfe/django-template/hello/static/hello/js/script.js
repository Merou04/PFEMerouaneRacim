document.addEventListener('DOMContentLoaded', function() {
    ...
    // Light control buttons (pour la compatibilité avec d'autres pages)
        ...
        toggleBtns.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                if (this.classList.contains('on')) {
                    ...
                    if (brightnessControl) brightnessControl.disabled = true;
                } else {
                    // Change to on
                    ...
                    if (brightnessControl) brightnessControl.disabled = false;
                }
            });
        });
    }
    
    // Door control buttons (pour la compatibilité avec d'autres pages)
    ...
    // Global control buttons for lights (pour la compatibilité avec d'autres pages)
    ...
    // Global control buttons for doors (pour la compatibilité avec d'autres pages)
